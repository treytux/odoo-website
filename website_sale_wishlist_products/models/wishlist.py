...
class WishlistProducts(models.Model):
    ...
    _name = 'wishlist_products'

    wishlist_id = fields.Many2one('wishlist')
    product_tmpl_id = fields.Many2one('product.template')
    # create_date = fields.Datetime(default=lambda this: fields.Datetime.now())
...
class Wishlist(models.Model):
    ...
    product_ids = fields.Many2many('product.template', 'wishlist_products', 'wishlist_id', 'product_tmpl_id')
